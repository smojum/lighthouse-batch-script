...
program
    ...
    .option('-f, --file [path]', 'an input file with a site url without the base url per-line to analyze with Lighthouse')
    ...
    .option('-c, --csv', 'generate an csv report alongside the json report')
